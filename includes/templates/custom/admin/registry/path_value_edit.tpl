<? CForm::begin($_table); ?>
	...
	<? if($id): ?>
		<h2><? CTemplate::loc_string('path'); ?>: <? echo $path_title; ?> -> <? CTemplate::loc_string('value'); ?>: <? echo $title; ?></h2>
	<? else: ?>
		<h2><? CTemplate::loc_string('path'); ?>: <? echo $path_title; ?> -> <? CTemplate::loc_string('new_value'); ?></h2>
	<? endif; ?>
